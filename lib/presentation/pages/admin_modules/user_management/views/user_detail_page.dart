...
class UserDetailPageView extends GetView<UserManagementController> {
  var userId;

  UserDetailPageView({this.userId, super.key}) {
            ...
            Column(
              ...
              children: [
                ...
                showTitleAndValue(
                    ...
                    value: controller.userDataModel.value?.roleId ==
                        APIEndpoint.userRole
                        ? AppStrings.farmer
                        : AppStrings.admin),
                showTitleAndValue(
                    title: '${AppStrings.gender} :- ',
                    value: controller.userDataModel.value?.gender ==
                        APIEndpoint.male ? AppStrings.male : controller
                        .userDataModel.value?.gender == APIEndpoint.female
